...
function data_handing(){
    for(let i=0; i<input.length; i++){
        console.log(`Nomor ID: ${input[i].slice(0,1)}`)
        console.log(`Nama Lengkap: ${input[i].slice(1,2)}`)
        console.log(`TTL: ${input[i].slice(2,3)} ${input[i].slice(3,4)}`)
        console.log(`Hobi: ${input[i].slice(4)}`)
        console.log(" ")
    }
}
